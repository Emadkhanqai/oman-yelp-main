...
@Component({
    selector: 'app-grid-listings-right-sidebar',
    templateUrl: './grid-listings-right-sidebar.component.html',
    styleUrls: ['./grid-listings-right-sidebar.component.scss']
})
export class GridListingsRightSidebarComponent implements OnInit {
