...
@Component({
    selector: 'app-dashboard-bookmarks',
    templateUrl: './dashboard-bookmarks.component.html',
    styleUrls: ['./dashboard-bookmarks.component.scss']
})
export class DashboardBookmarksComponent implements OnInit {
